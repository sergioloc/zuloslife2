...
public class RippleEffect_RenderPassFeature : ScriptableRendererFeature
{
    class RippleEffect_RenderPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (Application.isPlaying && RippleEffect.instance.currentAmount > RippleEffect.LOWEST_AMOUNT_VALUE)
            {
                ...
                if (destination == RenderTargetHandle.CameraTarget)
                {
                    ...
                    Blit(cmd, source, m_TemporaryColorTexture.Identifier(), RippleEffect.instance.rippleMaterial, blitShaderPassIndex);
